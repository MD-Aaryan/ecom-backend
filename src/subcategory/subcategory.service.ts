...
export class SubcategoryService {
  ...
  async create(dto: CreateSubcategoryDto) {
    ...
    if (!category || !category.isActive) throw new BadRequestException('Parent category not found or inactive');
  ...
  findAll(categoryId?: number) {
    ...
    return this.prisma.subcategory.findMany({ where, include: { category: true } });
  }
